        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">All Claims</h3> </div>
...
<?php
                    ...
                    $sql = "SELECT a.emp_id,c.emp_name, b.name, a.amount,a.detail_id, a.date_of, a.status FROM detailed_req as a, category as b, employee as c WHERE  a.cat_id=b.cat_id and a.emp_id=c.emp_id" ;
